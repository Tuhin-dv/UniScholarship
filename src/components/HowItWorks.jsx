            ...
            <div className="max-w-6xl mx-auto px-4 text-center">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10">
                    {steps.map((step, index) => (
                        <div
                            key={index}
                            className="relative bg-white/5 border border-white/20 rounded-xl p-6 transition-transform duration-500 hover:scale-105 shadow-xl hover:shadow-purple-500/20 backdrop-blur-md"
                        >
